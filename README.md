...
> 🌐 **English version:** [`README.en.md`](README.en.md) · English translations of the
> docs: [`REVIEW.en.md`](REVIEW.en.md), [`LITERATURE.en.md`](LITERATURE.en.md),
> [`CHANGELOG.en.md`](CHANGELOG.en.md), [`TOY_MODEL.en.md`](TOY_MODEL.en.md).
> Основной язык проекта — **русский** (этот файл авторитетный).
...
> ER/toy-контроли, тесты.
>
> **Полный обзор работы, выводов и открытых вопросов — в [`REVIEW.md`](REVIEW.md).**
> Разбор литературы — `LITERATURE.md`; история — `CHANGELOG.md`.
